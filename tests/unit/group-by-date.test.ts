...
it("groups transactions that fall on the same Seoul day together", () => {
  const transactions = [
    { id: "1", transactionAt: "2026-08-11T01:00:00.000Z" },
    { id: "2", transactionAt: "2026-08-11T10:00:00.000Z" },
    { id: "3", transactionAt: "2026-08-10T01:00:00.000Z" },
  ];
...
it("assigns a late-UTC transaction to the next Seoul day instead of splitting it from the rest of that Seoul day", () => {
  const transactions = [
    { id: "1", transactionAt: "2026-08-11T20:00:00.000Z" },
    { id: "2", transactionAt: "2026-08-12T01:00:00.000Z" },
  ];

  expect(groupTransactionsByDate(transactions)).toEqual([
    { date: "2026-08-12", transactions: [transactions[0], transactions[1]] },
  ]);
});
